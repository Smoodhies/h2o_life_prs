    ...
    return (
        <button
            ...
            style={{
                ...
                backgroundColor: isDark ? 'rgba(10,20,45,0.7)' : 'rgba(255,255,255,0.5)',
                boxShadow: 'inset 0 1px 0 rgba(255,255,255,0.4), 0 2px 12px rgba(0,0,0,0.2), 0 0 0 1px rgba(255,255,255,0.15)',
            }}
        >
            {/* Sliding knob */}
            <div
