        ...
        <>
            ...
            <div
                style={{
                    ...
                    backdropFilter: 'blur(28px) saturate(180%)',
                    WebkitBackdropFilter: 'blur(28px) saturate(180%)',
                    boxShadow: '-4px 0 32px rgba(0, 0, 0, 0.4), inset 1px 0 2px rgba(255, 255, 255, 0.4)',
                    border: '1px solid rgba(255, 255, 255, 0.18)',
                    borderRight: 'none',
            ...
            >
                ...
                <div style={{ marginTop: '60px', display: 'flex', flexDirection: 'column', gap: '8px', position: 'relative', zIndex: 1 }}>
                {NAV_ITEMS.map((item) => (
                    <a
                        key={item.href}
                        href={item.href}
                        ...
                        style={{
                            ...
                            transition: 'all 0.3s ease',
                            textShadow: '0 0.5px 1px rgba(255, 255, 255, 0.6)',
                            boxShadow: '0 2px 8px rgba(0, 0, 0, 0.05), inset 0 1px 1px rgba(255, 255, 255, 0.3)',
                        }}
                        onMouseEnter={(e) => {
                            e.currentTarget.style.background = 'rgba(255, 255, 255, 0.2)';
